    ...
    <MainLayout title={'매니아 발굴기'}>
      ...
      <div className={styles.content__wrap}>
        <div className={styles.summary}>
          <p>
            <span>"지금 내가 사랑하는 것들을 앞으로도 사랑해야겠다는 마음을 가지게 해줬어요."<br /><br /></span>
            자신이 사랑하는 것들을 지키기 위해 노력하는 20대 대학생을 만나보았다.
            그는 10대 때부터 공연을 사랑해왔고, 지금은 자신이 가장 좋아하는 아티스트와 함께 일하는 삶을 살고 있다.
        ...
        <p className={styles.content__ans}>
          ...
          '한국사람' 노래는 페이스북이 한창 흥했을 때 우연히 언더 래퍼 커뮤니티에서 접했어요.
        ...
        <p className={styles.content__ques}>
          성덕을 넘어 덕업 일치의 삶을 살고 계신 것 같아요. 처음엔 음감회를 기획했다고 하셨는데, 당시 상황들을 조금 더 자세히 설명해 주실 수 있을까요?
        </p>
        <p className={styles.content__ans}>
          &nbsp;음감회는 팬분들이 요가 매트에 앉아 안대를 끼고 감상하는 컨셉으로 진행됐어요.
          ...
          물론 휴대폰 사용도 금지였어요. 프라이빗 한 공연이기도 했고,
        ...
        <p className={styles.content__ans}>
          ...
          저는 모쉬핏 문화를 좋아하는데, 이게 워낙 마이너 한 문화라(웃음).
        </p>
        ...
        <p className={styles.content__ans}>
          ...
          &nbsp;범위를 좁혀보자면, 딥하고 마이너 한 감성을 좋아하는 리스너 분들께 추천드리고,
          그중에서도 chill 한 느낌을 선호한다면 {'<전설>'} 앨범을 1순위로 추천드립니다.
        </p>
        ...
        <p className={styles.content__ques}>
          ...
          그런 만큼 아티스트뿐만 아니라 리스너가 가져야 하는 자세에 대한 얘기들도 많아지고 있는데요,
          예원 씨는 '성숙한 리스너'라는 게 어떤 건지 고민해 보신 적 있나요?
        </p>
        <p className={styles.content__ans}>
          &nbsp;제가 언더 힙합 신을 좋아하다 보니, 아티스트가 금전적으로 힘들어서 작업을 이어가지 못하는 경우를 종종 봤어요.
          그래서인지 '음악을 듣기만 해도 팬인가 vs 소비를 해야만 팬인가'라는 쟁점에 대해 나름대로 고민해 본 적이 있어요.
          이건 가치관 차이이긴 한데, 저는 소비를 해야 한다고 생각하는 쪽이에요.
        ...
        <p className={styles.content__ques}>
          ...
          그런 예원 씨가 앞으로 어떤 색깔의 공연을 만들어나갈지 궁금해집니다.<br /><br />
