...
export const questionList: Array<questionType> = [
  {
    question: '나는 출근길 혹은 등굣길에 음악 앱을 켜서,',
    answers: [
      <>자연스럽게 어제 듣던<br />플레이리스트를 재생한다.</>,
      <>최신 음악, TOP100에서<br />골라 듣는다.</>,
    ],
    result: [
      [
  ...
  },
  {
    ...
    answers: [
      <>꽤 다양해서 어떤 곡을<br />말해야 할지 망설여진다.</>,
      <>어느 아티스트의 어떤 곡인지<br />곧바로 대답할 수 있다.</>,
    ],
    result: [
      [
        ListenerTypeName.TENDER,
  ...
  {
    question: '주로 아티스트에게 반하는 포인트는?',
    answers: [
      <>무대 위 프로페셔널하고<br />빛나는 모습</>,
      <>무대 뒤 인간적이고<br />솔직한 모습</>,
    ],
    result: [
      [
        ListenerTypeName.CANDID,
  ...
  },
  {
    ...
    answers: [
      <>CD, LP를 수집하거나,<br />비하인드를 찾아보는 등<br />혼자서 즐겨도 충분하다.</>,
      <>리뷰창, 댓글창에서<br />같은 취향의 사람들과<br />공유하면 더욱 즐겁다.</>,
    ],
    result: [
      [
        ListenerTypeName.CHERISH,
  ...
  },
  {
    ...
    answers: [
      <>이미 나와 있는 음악들로도<br />즐기기에 충분하다.</>,
      <>앞으로 새롭게 등장할<br />음악들이 기대된다.</>,
    ],
    result: [
      [
        ListenerTypeName.CHERISH,
